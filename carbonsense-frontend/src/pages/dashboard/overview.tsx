...
function OverviewContent() {
  ...
  if (initialLoading) {
    return (
      <div className="fixed inset-0 z-[200] bg-[#fafafa] dark:bg-[#030303] text-slate-900 dark:text-slate-50 overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 px-6 text-center">
          ...
          <p className="text-sm text-muted-foreground max-w-sm">
            Pulling the latest emission records and stats. First load can take a few seconds.
          </p>
        </div>
      </div>
    );
